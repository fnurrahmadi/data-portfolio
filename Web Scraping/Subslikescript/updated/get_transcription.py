...
df = pd.read_csv('Most cuss words in a movie\scraped_transcriptions.csv', encoding='utf-8', delimiter=';')
...
df_existing = pd.read_csv('scrape_transcriptions_1.csv', encoding='utf-8', delimiter=';')

df_movies = pd.concat([df_new, df_existing])
df_movies = df_movies.drop_duplicates()

print(df_movies)
df_movies.to_csv('scrape_transcriptions_1.csv', index=False, encoding='utf-8', sep=';')
